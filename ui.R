  ...
  tabItems(
    tabItem(
      ...
      fluidRow(
        column(width = 12,
               box(width = 12,
                   column(width = 3, fileInput("data", "Data (in form of ID | Locus | Cluster assignments): ",
    ...
    # textInput("posV", "Positive value: ", value = "Human"),
    tabItem(
      tabName = "tab-params", 
      ...
      fluidRow(
        column(width = 10, offset = 1, 
               box(width = 12, uiOutput("click_results")))), 
            
      fluidRow(
        column(width = 10, offset = 1, 
               DTOutput("results"))), tags$br(), tags$br(), 
            
      fluidRow(
        column(width = 10, offset = 1, 
               uiOutput("dnldB_final"), DTOutput("final")))
      )
    )
)
